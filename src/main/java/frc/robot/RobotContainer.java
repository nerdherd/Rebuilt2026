...
public class RobotContainer {
  ...
  public void configureDriverBindings_teleop() {
    ...
    driverController.bumperLeft().onTrue(shooterPrototype.setDesiredValueCommand(10.0).andThen(shooterPrototype.setEnabledCommand(true))).onFalse(shooterPrototype.setDesiredValueCommand(0).andThen(shooterPrototype.setEnabledCommand(false)));
