# Goals:
- configure the new radio because the access point wasn't appearing

# Results:
- the radio was able be configured due to the network assistant tool. The error was the radio never had its own ip address. We were able to connect to the radio via ethernet because of the software we used.
- Tested drive and rotation of wheels
- Successfully calibrated swerve drive
