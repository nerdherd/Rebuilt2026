...
[^1]: From my testing, making the control length the same distance as the two start points and end points and t hen using the PathPlanner optimizer yields the lowest optimized runtime.